...
void main() {
  Connection connection = createHttpConnection("http://0.0.0.0:8080/resources/", new Duration(milliseconds: 200), 200);
  ...
  ParagraphElement stateElem = querySelector('#state');
  connection.onConnected.listen((_) {
    stateElem.text = "Connected";
  });

  connection.onDisconnected.listen((_) {
    stateElem.text = "Disconnected";
  });
